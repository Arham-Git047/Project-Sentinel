...
Here is a high-impact, professional, and readable `README.md` file tailored for **Project Sentinel**. It emphasizes the "Agentic" nature of the solution and the realistic engineering behind it.
...
Authorities currently react on **DAY 7**. Project Sentinel alerts them on **DAY 1**.
